      ...
      chart: {
        events: {
          load() {
            ...
            this.renderer.image(`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-energy_access/' : './'}assets/img/unctad_logo.svg`, 5, 15, 80, 100).add();
          }
        },
        height: 650,
        resetZoomButton: {
        ...
        chartOptions: {
          chart: {
            events: {
              load() {
                // eslint-disable-next-line react/no-this-in-sfc
                this.renderer.image(`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-energy_access/' : './'}assets/img/unctad_logo.svg`, 5, 15, 100, 100).add();
              }
            },
          },
          subtitle: {
