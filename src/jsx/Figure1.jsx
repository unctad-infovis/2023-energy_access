  ...
  return (
    <div className="app">
      ...
      <ChartLine
        ...
        subtitle="Share of the population with access to clean cooking fuels, Sub-Saharan Africa and worldwide, 2000 to 2020"
        suffix=""
        title="Most of Sub-Sharan population still lack the access to clean cooking fuels"
        ylabel=""
      />
      )}
